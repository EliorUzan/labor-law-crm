...
export const trustTransactionSchema = z.object({ clientId: recordIdSchema, matterId: optionalId, transactionType: z.enum(trustTransactionType.enumValues), recordDate: calendarDateSchema, amount: amountSchema, description: optionalText(10000), documentLink: optionalSafeHttpsUrlSchema });
export const taxPaymentSchema = z.object({ paymentKind: z.enum(taxPaymentKind.enumValues), taxType: optionalText(100), liabilityId: optionalId, recordDate: calendarDateSchema, amount: amountSchema, period: optionalText(100), description: optionalText(10000), documentLink: optionalSafeHttpsUrlSchema, notes: optionalText(10000) }).superRefine((value, context) => {
